...
class ForumViewsTestCase(TestCase):
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_add_comment_post_valid_data(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
        ...
        )  # Redirects after successful comment addition
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_add_comment_post_invalid_data(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_create_topic_post_invalid_data(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
        ...
        """
        # Set up mocks and call the view
        post_data = {"ride_id": "", "title": "", "content": ""}
        self.mock_db_setup()
        mock_get_client.return_value = self.mock_client
        response = self.client.post(reverse("create_topic"), data=post_data)
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_rides_with_no_available_rides(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_forum_topics_no_available_topics(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_forum_topic_details_no_comments(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_forum_multiple_topics(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_add_multiple_comments_to_topic(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
    ...
    @patch("forum.views.routesDB")
    @patch("forum.views.topicsDB")
    def test_create_topic_invalid_ride_id(
        self,
        mock_commentsDB,
        mock_topicsDB,
        mock_ridesDb,
