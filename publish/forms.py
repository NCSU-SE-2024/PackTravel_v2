...
class RideForm(forms.ModelForm):
    ...
    rideDate = forms.CharField(
        required=True,
        validators=[validate_date],
        widget=forms.TextInput(
            attrs={"placeholder": "Enter ride date", "class": "form-control"}
        ),
    )
    route = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={"placeholder": "Enter route", "class": "form-control"}
        ),
    )
    routeDetails = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={
