...
urlpatterns = [
    ...
    path('forum/rides-with-topics/',
         forumViews.rides_with_topics, name='rides_with_topics'),
    path('forum/topics/<ride_id>/', forumViews.forum_topics, name='forum_topics'),
    path('forum/topic/<topic_id>/', forumViews.forum_topic_details,
         name='forum_topic_details'),
    path('forum/add_comment/<topic_id>/',
         forumViews.add_comment, name='add_comment'),
